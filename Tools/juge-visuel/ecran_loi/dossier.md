# Dossier du juge visuel — ecran_loi — r1 — <AAAA-MM-JJ>
...
- **Routes du domaine** :
  ...
  - `POST /v1/me/legal/cases/:id/plea`
  - `POST /v1/me/legal/cases/:id/payoff`

## Référence (fait autorité : l'IMAGE)

| fichier | rôle | taille px | facteur de rendu | largeur CSS ↔ largeur Unity |
|---|---|---|---|---|
| `Tools/juge-visuel/v6/m-67.png` | rendu ratifié | <W×H> | <ex. ×2> | <ex. 300 CSS = 1280 u (canvas)> |
...
|---|---|---|---|---|
| `Assets/Screenshots/ecran_loi_1080x1920.png` | 1080×1920 | <ligne du log> | <jour> | `EcranLoiC1_CapturerPourLeJugeVisuel_DeuxResolutions` |
| `Assets/Screenshots/ecran_loi_1080x2400.png` | 1080×2400 | <ligne du log> | <jour> | `EcranLoiC1_CapturerPourLeJugeVisuel_DeuxResolutions` |
...
- les rapports des juges précédents (`Tools/juge-visuel/ecran_loi/r<k>/`, k < 1) — aucun ici, r1.
