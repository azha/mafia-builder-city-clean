# Dossier du juge visuel — ㉛ La loi (« le parloir ») — r1 — 2026-09-07
...
- **Nom** : La loi (« le parloir ») (㉛, canon `écran neuf, sans id canon`) — contrôleur `LoiScreenController`
...
- **Chemin joueur emprunté par la capture** : Plus → LA LOI
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #67) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `9fd7b6f` ;
  ...
  - #67 (l.4888) — Ils ont arrêté un de vos coursiers  ⇐ **cadre NOMINAL, rendu en référence**
  - #68 (l.4890) — Lui trouver un avocat
  - #69 (l.4892) — Il commence à parler
  - #70 (l.4894) — Il a tout dit
  - #71 (l.4896) — Il y a un arrangement
  - #72 (l.4898) — Votre avocat est nerveux
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_la_loi_1080x2400.png — sha256 9241e790…` |
