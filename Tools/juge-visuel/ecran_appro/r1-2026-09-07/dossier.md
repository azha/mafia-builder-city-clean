# Dossier du juge visuel — ㉚ La chaîne d'appro (« le bon de commande et la conduite qui refoule ») — r1 — 2026-09-07
...
- **Nom** : La chaîne d'appro (« le bon de commande et la conduite qui refoule ») (㉚, canon `écran neuf, sans id canon`) — contrôleur `ChaineDApproScreenController`
...
- **Chemin joueur emprunté par la capture** : Plus → LA CHAÎNE D'APPRO
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #48) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
| `etats/vide-maquette-appro.png` | maquette d'ÉTAT VIDE de l'atelier (`4e6697f`, `da/portraits-lieutenants`) — asset NON monté dans le client : juge le SENS, pas le pixel | 1024×1024 | inconnu | largeur 1024 px — échelle à établir par le juge (largeur / 300 CSS si c'est un .tel) |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `9fd7b6f` ;
  ...
  - #48 (l.4583) — Commander — et il n'y a plus rien  ⇐ **cadre NOMINAL, rendu en référence**
  - #49 (l.4585) — La commande est en route
  - #50 (l.4587) — Ça coince — un cran remonté
  - #51 (l.4589) — Ça coince — deux crans remontés
  - #52 (l.4591) — On a trouvé où ça coince
  - #53 (l.4593) — Commander ne vous appartient plus
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_la_chaine_d_appro_1080x2400.png — sha256 3f101c9a…` |
