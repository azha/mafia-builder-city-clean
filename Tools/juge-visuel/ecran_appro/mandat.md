# Mandat pré-rempli — ㉚ La chaîne d'appro — dossier `ecran_appro`
...
- **Cadres de la maquette** : `ecrans-brennar-6.html` 48, 49, 50, 51, 52, 53 — atelier `3c02f72`. Cadres d'ÉTATS : les autres numéros du groupe.
...
- `Assets/Screenshots/planche_la_chaine_d_appro_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
