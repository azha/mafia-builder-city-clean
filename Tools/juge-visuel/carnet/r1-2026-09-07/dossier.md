# Dossier du juge visuel — ㉞ Les ordres du soir (« le carnet, la ville, ce qui arrive ») — r1 — 2026-09-07
...
- **Nom** : Les ordres du soir (« le carnet, la ville, ce qui arrive ») (㉞, canon `écran neuf, sans id canon`) — contrôleur `CarnetScreenController`
...
- **Chemin joueur emprunté par la capture** : Plus → LES ORDRES DU SOIR
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #85) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
| `etats/vide-maquette-carnet.png` | maquette d'ÉTAT VIDE de l'atelier (`4e6697f`, `da/portraits-lieutenants`) — asset NON monté dans le client : juge le SENS, pas le pixel | 1024×1024 | inconnu | largeur 1024 px — échelle à établir par le juge (largeur / 300 CSS si c'est un .tel) |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `9fd7b6f` ;
  ...
  - #85 (l.5171) — Les ordres de ce soir  ⇐ **cadre NOMINAL, rendu en référence**
  - #86 (l.5173) — Deux ordres s'attendent
  - #87 (l.5175) — Un endroit n'a pas fini de se poser
  - #88 (l.5177) — Rejouer une soirée — pas encore
  - #89 (l.5179) — Rejouer une soirée
  - #90 (l.5181) — Ce qui s'est passé en ville
  - #91 (l.5183) — Ce qui arrive
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_signer_l_ordre_1080x2400.png — sha256 b04aaad9…` |
