...
- **Cadres de la maquette** : `ecrans-brennar-6.html` 85, 86, 87, 88, 89, 90, 91 — atelier `3c02f72`. Cadres d'ÉTATS : les autres numéros du groupe.
- **Attribution cadre ↔ écran** : déduite. cadres 85-91 (ordres du soir, rejouer, ce qui arrive) par le titre ; nom de planche à confirmer
...
- `Assets/Screenshots/planche_signer_l_ordre_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
