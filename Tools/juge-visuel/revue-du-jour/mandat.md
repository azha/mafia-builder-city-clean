...
## L'écran
- **Nom** : Daily Review (⑯, canon `screen_11`) — contrôleur `DailyReviewScreenController`
- **Ce qu'on vient y faire** (pré-rempli, front.md « Montre ») : les signalements du jour (nom du lieutenant · jour · chip de confiance · ce qui a été
- **Chemin joueur pour y arriver** : Plus → LA REVUE DU JOUR
...
- **État `front.md`** (en-tête) : · « La Revue du jour »  ★ *déclencheur de §S5* — ✅ **le mieux instruit**
...
- **Cadres de la maquette** : `ecrans-brennar-4.html` 0, 1, 2, 3 · `ecrans-brennar-6.html` 0, 1, 2, 3 — atelier `3c02f72`. Cadres d'ÉTATS : les autres numéros du groupe.
...
- `Assets/Screenshots/revue_du_jour_seuil-force-0.1_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
