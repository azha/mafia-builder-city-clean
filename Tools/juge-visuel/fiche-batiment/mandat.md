# Mandat pré-rempli — ② Building Card — dossier `fiche-batiment`
...
- `Assets/Screenshots/screen_2a_fiche_sous_chrome_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
