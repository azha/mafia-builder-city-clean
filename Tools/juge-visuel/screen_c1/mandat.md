# Mandat pré-rempli — ㊳ Le journal & la rue — dossier `screen_c1`
...
## L'écran
- **Nom** : Le journal & la rue (㊳, canon `sans id canon (écran neuf)`) — contrôleur `JournalScreenController`
- **Ce qu'on vient y faire** (pré-rempli, front.md « Montre ») : non fourni (front.md ne porte pas de puce « Montre » pour cet écran)
- **Chemin joueur pour y arriver** : Plus → LE JOURNAL & LA RUE
- **Routes lues dans le contrôleur** : `/v1/ambient/attend/`, `/v1/ambient/feed`, `/v1/news/beats/`, `/v1/news/feed`, `/v1/random-world/active`, `/v1/random-world/hollow/`, `/v1/random-world/known-couplings` (`Assets/Scripts/Operational/Journal/*.cs`)
- **État `front.md`** (en-tête) : — « ce qui se dit ce matin » · **ÉCRAN NEUF** (2026-08-27 nuit)

## Référence (fait autorité : l'IMAGE)
| fichier | rôle | taille px | facteur | largeur CSS ↔ largeur Unity |
|---|---|---|---|---|
| `screen_c1/reference-1080x2102.png` | cadre nominal `ecrans-brennar-6.html` #125 rendu | 1080×2102 | ×3.6 | 300 CSS = 1080 px |
- **Cadres de la maquette** : `ecrans-brennar-6.html` 125, 126, 127, 128, 129, 130 — atelier `3c02f72`. Cadres d'ÉTATS : les autres numéros du groupe.
- **Attribution cadre ↔ écran** : mesurée. le contrôleur cite les cadres 125 et 129
...
- `Assets/Screenshots/screen_c1_journal_sous_chrome_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
