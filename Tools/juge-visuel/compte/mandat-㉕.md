# Mandat pré-rempli — ㉕ First-time Tutorial — dossier `compte`
...
- `Assets/Screenshots/planche_la_premiere_fois_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
