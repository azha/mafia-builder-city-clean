# Mandat pré-rempli — ㉓ IAP Shop — dossier `compte`
...
|---|---|---|---|---|
| `compte/reference-㉓-1080x2102.png` | cadre nominal `ecrans-brennar-6.html` #98 rendu | 1080×2102 | ×3.6 | 300 CSS = 1080 px |
...
- `Assets/Screenshots/planche_la_vitrine_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
