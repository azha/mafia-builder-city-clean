# Mandat pré-rempli — ㊵ Le blanchiment — dossier `screen_c2`
...
- **Cadres de la maquette** : `ecrans-brennar-6.html` 137, 138, 139, 140, 141, 142 — atelier `3c02f72`. Cadres d'ÉTATS : les autres numéros du groupe.
- **Attribution cadre ↔ écran** : mesurée. le contrôleur cite le cadre 142 (« ce qui manque encore »)
...
- `Assets/Screenshots/screen_c2_filiere_sous_chrome_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
