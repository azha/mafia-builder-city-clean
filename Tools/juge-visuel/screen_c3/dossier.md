# Dossier du juge visuel — screen_c3 — r1 — <AAAA-MM-JJ>
...
|---|---|---|---|---|
| `Tools/juge-visuel/v6/m-85.png` | rendu ratifié | <W×H> | <ex. ×2> | <ex. 300 CSS = 1280 u (canvas)> |
...
|---|---|---|---|---|
| `Assets/Screenshots/screen_c3_1080x1920.png` | 1080×1920 | <ligne du log> | <jour> | `ScreenC3C1_CapturerPourLeJugeVisuel_DeuxResolutions` |
| `Assets/Screenshots/screen_c3_1080x2400.png` | 1080×2400 | <ligne du log> | <jour> | `ScreenC3C1_CapturerPourLeJugeVisuel_DeuxResolutions` |
...
- les rapports des juges précédents (`Tools/juge-visuel/screen_c3/r<k>/`, k < 1) — aucun ici, r1.
