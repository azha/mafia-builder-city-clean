# Dossier du juge visuel — ⑮ Les inspections (MIS Inspection Queue) — r1-⑮ — 2026-09-07
...
|---|---|---|---|---|
| `reference-⑮-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #31) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
| `etats/inspections-canon.png` | canon de la série 2 (état garni) | 900×1752 | ×3,0 | 300 CSS = 900 px |
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_les_inspections_1080x2400.png — sha256 473697b8…` |
