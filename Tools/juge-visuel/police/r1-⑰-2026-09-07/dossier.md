# Dossier du juge visuel — ⑰ Le commissariat (Precinct View) — r1-⑰ — 2026-09-07
...
- **Nom** : Le commissariat (Precinct View) (⑰, canon `screen_9`) — contrôleur `PrecinctScreenController`
- **Ce qu'on vient y faire** : la mémoire du precinct, l'achat de renseignement, le recrutement de clerc (front.md « Montre »)
...
|---|---|---|---|---|
| `reference-⑰-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #32) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
| `etats/commissariat-canon.png` | canon de la série 2 (état garni) | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/commissariat-vide.png` | canon de la série 2 (état VIDE) | 900×1752 | ×3,0 | 300 CSS = 900 px |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `9fd7b6f` ;
  ...
  - #31 (l.1043) — La police — le tableau : ce qu’ils savent
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_le_commissariat_1080x2400.png — sha256 0150f2ce…` |
