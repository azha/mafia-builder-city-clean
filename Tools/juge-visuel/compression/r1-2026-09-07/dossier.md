# Dossier du juge visuel — ⑭ La semaine (Compression Week Board) — r1 — 2026-09-07
...
- **Nom** : La semaine (Compression Week Board) (⑭, canon `screen_13`) — contrôleur `CompressionScreenController`
- **Ce qu'on vient y faire** : le tableau des problèmes de la semaine de compression, décisions, report (front.md « Montre »)
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-4.html` #25) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
| `etats/ecran-canon.png` | canon de la série 2 (semaine en cours) | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/ecran-canon-vide.png` | canon de la série 2 (aucune semaine) | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/ecran-annoncee.png` | canon de la série 2 (semaine ANNONCÉE) | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/v4-25.png` | cadre série 4 #25 rendu | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/v4-26.png` | cadre série 4 #26 rendu | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/v4-27.png` | cadre série 4 #27 rendu | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/v4-28.png` | cadre série 4 #28 rendu | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/v4-29.png` | cadre série 4 #29 rendu | 900×1752 | ×3,0 | 300 CSS = 900 px |
| `etats/v4-30.png` | cadre série 4 #30 rendu | 900×1752 | ×3,0 | 300 CSS = 900 px |

- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-4.html` (atelier `9fd7b6f` ;
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_la_semaine_1080x2400.png — sha256 0f4f6fc5…` |
...
- **Contenu déclaré par les corps de commit** : aucune déclaration de contenu dans les corps de commit ; l'état de la semaine (annoncée / en cours / aucune) est à LIRE sur l'image et à apparier au cadre d'état homologue (`etats/`).
...
- La référence est un cadre de la **série 4** (`ecrans-brennar-4.html` #25) ; la série 6 (#14–19) porte le même écran — l'INDEX cite les deux, la référence rendue est la série 4. Si la capture montre un état (annoncée / aucune) autre que le nominal, choisis le canon d'état homologue dans `etats/` et dis-le.
