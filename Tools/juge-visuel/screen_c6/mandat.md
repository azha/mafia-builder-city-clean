# Mandat pré-rempli — ㊱ L'horizon des possibles — dossier `screen_c6`
...
- **Cadres de la maquette** : `ecrans-brennar-6.html` 113, 114, 115, 116, 117, 118 — atelier `3c02f72`. Cadres d'ÉTATS : les autres numéros du groupe.
...
- `Assets/Screenshots/screen_c6_horizon_etat-vide_sous_chrome_1080x2400.png` — existe. Une capture est une mesure DATÉE : la reprendre APRÈS
