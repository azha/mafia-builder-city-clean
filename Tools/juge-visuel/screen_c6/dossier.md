# Dossier du juge visuel — screen_c6 — r1 — <AAAA-MM-JJ>
...
|---|---|---|---|---|
| `~/project/atelier3d-mafia/generateur-horizon.py` | rendu ratifié | <W×H> | <ex. ×2> | <ex. 300 CSS = 1280 u (canvas)> |
...
|---|---|---|---|---|
| `Assets/Screenshots/screen_c6_1080x1920.png` | 1080×1920 | <ligne du log> | <jour> | `ScreenC6C1_CapturerPourLeJugeVisuel_DeuxResolutions` |
| `Assets/Screenshots/screen_c6_1080x2400.png` | 1080×2400 | <ligne du log> | <jour> | `ScreenC6C1_CapturerPourLeJugeVisuel_DeuxResolutions` |
...
- les rapports des juges précédents (`Tools/juge-visuel/screen_c6/r<k>/`, k < 1) — aucun ici, r1.
