# Dossier du juge visuel — ㉟ La vente (« les points de vente ») — r1 — 2026-09-07
...
- **Nom** : La vente (« les points de vente ») (㉟, canon `écran neuf, sans id canon`) — contrôleur `SellingScreenController`
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #107) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | sous chrome, par la suite de l'écran (`LaVenteCapturePlayModeTests`) — campagne `fd0e21e` (06/09 20:53) | 06/09 20:53 (`fd0e21e`) | `la_vente_1080x2400.png — sha256 5371053c…` |
| `capture-planche-1080x2400.png` | 1080×2400 | surimpression sous chrome (test de planche) — autre campagne — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_la_vente_1080x2400.png — sha256 94f76f26…` |
...
- **Contenu déclaré par les corps de commit** : le corps de commit `1d3d412` signalait sur `la_vente` : « manomètre *Unknown* (chrome non alimenté) » et « aucune planque n'existe encore » alors que l'empreinte compte 2 planques — DÉCLARÉ pour une campagne ANTÉRIEURE (06:56) ; vérifie sur la planche fournie (20:53) si c'est encore le cas, et classe (chrome non alimenté = état de run, pas l'écran ; « aucune planque » avec 2 planques en base = SENS faux si la planche le montre).
