# Dossier du juge visuel — ecran_conflit — r1 — <AAAA-MM-JJ>
...
- **Routes du domaine** :
  ...
  - `POST /v1/me/engagements`

## Référence (fait autorité : l'IMAGE)

| fichier | rôle | taille px | facteur de rendu | largeur CSS ↔ largeur Unity |
|---|---|---|---|---|
| `Tools/juge-visuel/v6/m-65.png` | rendu ratifié | <W×H> | <ex. ×2> | <ex. 300 CSS = 1280 u (canvas)> |
...
|---|---|---|---|---|
| `Assets/Screenshots/ecran_conflit_1080x1920.png` | 1080×1920 | <ligne du log> | <jour> | `EcranConflitC1_CapturerPourLeJugeVisuel_DeuxResolutions` |
| `Assets/Screenshots/ecran_conflit_1080x2400.png` | 1080×2400 | <ligne du log> | <jour> | `EcranConflitC1_CapturerPourLeJugeVisuel_DeuxResolutions` |
...
- les rapports des juges précédents (`Tools/juge-visuel/ecran_conflit/r<k>/`, k < 1) — aucun ici, r1.
