# Dossier du juge visuel — ㉙ Le conflit (« la table du fond ») — r1 — 2026-09-07
...
- **Nom** : Le conflit (« la table du fond ») (㉙, canon `écran neuf, sans id canon`) — contrôleur `ConflitScreenController`
...
- **Chemin joueur emprunté par la capture** : Plus → LE CONFLIT
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #59) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
| `etats/vide-maquette-conflit.png` | maquette d'ÉTAT VIDE de l'atelier (`4e6697f`, `da/portraits-lieutenants`) — asset NON monté dans le client : juge le SENS, pas le pixel | 1024×1024 | inconnu | largeur 1024 px — échelle à établir par le juge (largeur / 300 CSS si c'est un .tel) |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `9fd7b6f` ;
  ...
  - #59 (l.4784) — Le premier coup — on n'a jamais croisé personne  ⇐ **cadre NOMINAL, rendu en référence**
  - #60 (l.4786) — Le septième coup — la vendetta est visible
  - #61 (l.4788) — Deux choses ne collent pas
  - #62 (l.4790) — Ce qui est en cours
  - #63 (l.4792) — Ce qui est rentré
  - #64 (l.4794) — Ce qu'on ne peut pas faire
  - #65 (l.4812) — v1 — la table du fond
  - #66 (l.4814) — v1 — il est rentré
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_le_conflit_1080x2400.png — sha256 514504c8…` |
