# Dossier du juge visuel — ㉝ Raser un site (« la fiche et la parcelle libérée ») — r1 — 2026-09-07
...
- **Nom** : Raser un site (« la fiche et la parcelle libérée ») (㉝, canon `écran neuf, sans id canon`) — contrôleur `DemolitionScreenController`
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #80) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `9fd7b6f` ;
  ...
  - #79 (l.5067) — L'organisation frotte
  - #80 (l.5069) — Ce bâtiment vous coûte  ⇐ **cadre NOMINAL, rendu en référence**
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_raser_un_site_1080x2400.png — sha256 173534a5…` |
