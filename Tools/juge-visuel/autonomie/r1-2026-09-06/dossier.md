# Dossier du juge visuel — ㉔ L'autonomie (« le burner ») — r1 — 2026-09-06
...
- **Nom** : L'autonomie (« le burner ») (㉔, canon `screen_c7`) — contrôleur `AutonomyInboxController`
- **Ce qu'on vient y faire** : un téléphone à clapet : les messages de ceux qui ont refusé d'agir seuls — lire chaque rapport, taper 1 ou 2 pour trancher, voir ce qui traîne depuis plusieurs cycles.
- **Chemin joueur emprunté par la capture** : Accueil → rapports d'autonomie (`DashboardController.cs:308`) — ici monté en surimpression par le test de planche, compte de démo.
- **États capturés** : un seul : le compte de démo (des rapports, ou « aucun message »).

## Référence (fait autorité : l'IMAGE)

| fichier (dans ce dossier) | rôle | taille px | facteur | largeur CSS ↔ largeur écran |
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (série 6 #25 « le burner : deux messages ») | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `eb1eb55` ;
  ...
  - #25 (l.954) — Autonomie — le burner : deux messages  ⇐ **cadre NOMINAL, rendu en référence**
  - #26 (l.966) — Autonomie — un message : tapez 1 ou 2
  - #27 (l.978) — Autonomie — le même homme, chaque cycle
  - #28 (l.990) — Autonomie — OPTIONS : traiter la cause
  - #29 (l.1002) — Autonomie — après votre réponse
  - #30 (l.1014) — Autonomie — aucun message
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 | compte de démo, surimpression | 2026-09-04 11:22 | `PlancheEcransManquantsCapturePlayModeTests (`planche_l_autonomie_1080x2400.png`)` |
