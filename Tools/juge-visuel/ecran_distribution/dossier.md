# Dossier du juge visuel — ecran_distribution — r1 — <AAAA-MM-JJ>
...
- **Nom** : La distribution (`ecran_distribution`)
...
- **Routes du domaine** :
  - `GET /v1/operational/couriers`
  - `GET /v1/operational/distribution/projection`
  - `POST /v1/operational/distribution/dispatch`
...
|---|---|---|---|---|
| `Tools/juge-visuel/v6/m-54.png` | rendu ratifié | <W×H> | <ex. ×2> | <ex. 300 CSS = 1280 u (canvas)> |
...
|---|---|---|---|---|
| `Assets/Screenshots/ecran_distribution_1080x1920.png` | 1080×1920 | <ligne du log> | <jour> | `EcranDistributionC1_CapturerPourLeJugeVisuel_DeuxResolutions` |
| `Assets/Screenshots/ecran_distribution_1080x2400.png` | 1080×2400 | <ligne du log> | <jour> | `EcranDistributionC1_CapturerPourLeJugeVisuel_DeuxResolutions` |
...
- les rapports des juges précédents (`Tools/juge-visuel/ecran_distribution/r<k>/`, k < 1) — aucun ici, r1.
