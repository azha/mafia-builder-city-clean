# Dossier du juge visuel — ㉘ La distribution (« la ficelle sur le liège ») — r1 — 2026-09-07
...
- **Nom** : La distribution (« la ficelle sur le liège ») (㉘, canon `écran neuf, hors canon`) — contrôleur `DistributionScreenController`
...
- **Chemin joueur emprunté par la capture** : Plus → LA DISTRIBUTION
...
|---|---|---|---|---|
| `reference-1080x2102.png` | rendu du cadre nominal (`ecrans-brennar-6.html` #54) | 1080×2102 | ×3,6 | 300 CSS = 1080 px |
| `etats/vide-maquette-distribution.png` | maquette d'ÉTAT VIDE de l'atelier (`4e6697f`, `da/portraits-lieutenants`) — asset NON monté dans le client : juge le SENS, pas le pixel | 1024×1024 | inconnu | largeur 1024 px — échelle à établir par le juge (largeur / 300 CSS si c'est un .tel) |
...
- **Source HTML/CSS** (aide de lecture, ne prime JAMAIS sur l'image) : `/home/erutheone/project/atelier3d-mafia/ecrans-brennar-6.html` (atelier `9fd7b6f` ;
  ...
  - #54 (l.4684) — Envoyer — la ficelle à tendre  ⇐ **cadre NOMINAL, rendu en référence**
  - #55 (l.4686) — En route — ça serpente
  - #56 (l.4688) — Livré — mais la route s'use
  - #57 (l.4690) — La route est coupée
  - #58 (l.4692) — Ils ont pris Lt. Tull
...
|---|---|---|---|---|
| `capture-1080x2400.png` | 1080×2400 — PRINCIPALE | surimpression sous chrome (test de planche) — campagne `03efb90` (06/09 14:56) | 06/09 14:56 (`03efb90`) | `planche_la_distribution_1080x2400.png — sha256 b3191c78…` |
